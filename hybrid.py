...
def hybrid_approach(trainset, testset, phase = "Test", weights = []):
	if phase == "Train":
		...
		file = open('prediction_baseline.txt', 'wb')
		...
		file = open('predictions_svd.txt', 'wb')
		...
		file = open('predictions_svdpp.txt', 'wb')
		...
		file = open('predictions_s1.txt', 'wb')
		...
		file = open('predictions_co.txt', 'wb')
		...
		file = open('predictions_knn.txt', 'wb')
		...
		file = open('mae_arr.txt', 'wb')
		pickle.dump(mae_arr, file)
		file.close()

		file = open('rmse_arr.txt', 'wb')
